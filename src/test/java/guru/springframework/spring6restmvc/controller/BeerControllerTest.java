...
class BeerControllerTest {
    ...
    BeerServiceImpl beanServiceImpl = new BeerServiceImpl();

    @Test
    void getBeerById() throws Exception {
        Beer testBear = beanServiceImpl.listBeers().get(0);
    ...
    void testListBeers() throws Exception {
        given(beerService.listBeers()).willReturn(beanServiceImpl.listBeers());
